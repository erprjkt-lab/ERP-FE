          ...
          <div className="grid gap-8 lg:grid-cols-2">
            {SERVICES.map(({ icon: Icon, title, to, description, points }, i) => (
              <Reveal key={title} delay={i * 0.1}>
                <div className="card-hover group flex h-full flex-col rounded-3xl border border-ink-100 bg-white p-10 shadow-card">
                  ...
                  <h2 className="mt-6 font-display text-2xl font-semibold text-ink-900">{title}</h2>
